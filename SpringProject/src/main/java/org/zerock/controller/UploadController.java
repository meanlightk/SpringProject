...
public class UploadController {
	...
	@ResponseBody
	public ResponseEntity<List<GoodsImage>> uploadAjaxPost(@RequestParam("gno") String gno,
	...
	@ResponseBody
	public ResponseEntity<List<GoodsImage>> uploadAjaxPost2(@RequestParam("gno") String gno,
			MultipartFile[] uploadFile) {
